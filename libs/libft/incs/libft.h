...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/04/17 19:13:21 by alephoen          #+#    #+#             */
/*   Updated: 2025/09/22 00:36:12 by alephoen         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*ft_substr(const char *src, unsigned int beg, size_t len);
char	*ft_strjoin(char const *s1, char const *s2);
char	*ft_strtrim(const char *s, const char *set);
char	**ft_split(const char *str, char c, size_t len);
